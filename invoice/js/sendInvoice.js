...
let goBackbtn =    `<img src="images/arrow-left-solid.svg" style="margin-top: 0.5em;" alt="Go Back" width="20px"/>`;

let previousForm = () => {
    payerForm.style.display = 'flex'
    submitForm.style.display = 'none'
    goBack.innerHTML = ""
    document.querySelector('.lead').innerHTML = "Please enter customer's payment details to continue"
}
/*
let nextPage = (event) => {
...
let nextPage = (event) => {
    ...
    goBack.innerHTML = goBackbtn
    document.querySelector('.lead').innerHTML = "Kindly complete the information below to send payers’ invoice"
...
goBack.addEventListener("click", previousForm)
